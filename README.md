...
## Extended progress debugging
Set `extended_progress_debug=yes` in `encoder.conf` for startup timing and encoder input/output counts.  
This option requires FFmpeg 6.0 or newer; ordinary encoding does not.
